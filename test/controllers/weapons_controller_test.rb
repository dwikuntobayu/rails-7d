...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { description: @weapon.description, dimention: @weapon.dimention, type: @weapon.type, weight: @weapon.weight }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { description: @weapon.description, dimention: @weapon.dimention, type: @weapon.type, weight: @weapon.weight }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
